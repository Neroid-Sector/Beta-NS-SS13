...
/datum/skills/tis
	...
	skills = list(
		...
		SKILL_EXECUTION = SKILL_EXECUTION_DEFAULT, //cannot BE people
		SKILL_INTEL = SKILL_INTEL_EXPERT
	)

/datum/skills/tiscomm
	name = "TIS Command"
	skills = list(
...
/datum/skills/ms/rifleman
	name = "MS Standard Marine"
	skills = list(
		SKILL_FIREARMS = SKILL_FIREARMS_TRAINED,
		SKILL_CQC = SKILL_CQC_SKILLED,
		SKILL_ENDURANCE = SKILL_ENDURANCE_TRAINED,
