/datum/equipment_preset/clf
	name = FACTION_CLF
	languages = list(LANGUAGE_JAPANESE, LANGUAGE_FRENCH, LANGUAGE_FRENCH, LANGUAGE_HINDI, LANGUAGE_ENGLISH)
	assignment = JOB_CLF
	rank = FACTION_CLF
	faction = FACTION_CLF
