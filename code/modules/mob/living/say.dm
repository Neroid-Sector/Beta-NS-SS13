var/list/department_radio_keys = list(
	...
	"&G" = RADIO_CHANNEL_PATTONS_GHOST_GEN, "&V" = RADIO_CHANNEL_PATTONS_GHOST_CMD, "&E" = RADIO_CHANNEL_PATTONS_GHOST_ENGI, "&M" = RADIO_CHANNEL_PATTONS_GHOST_MED, "&C" = RADIO_CHANNEL_PATTONS_GHOST_CARO,
)
