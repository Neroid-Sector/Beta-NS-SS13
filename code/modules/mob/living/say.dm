var/list/department_radio_keys = list(
	...
	"#L" = RADIO_CHANNEL_LIBERTY_STAR_GEN, "#1" = RADIO_CHANNEL_LIBERTY_STAR_CMD, "#E" = RADIO_CHANNEL_LIBERTY_STAR_ENGI, "#M" = RADIO_CHANNEL_LIBERTY_STAR_MED, "#C" = RADIO_CHANNEL_LIBERTY_STAR_CARGO,

	"#A" = RADIO_CHANNEL_AEGIS_GEN, "#2" = RADIO_CHANNEL_AEGIS_CMD, "$E" = RADIO_CHANNEL_ENGI, "$M" = RADIO_CHANNEL_AEGIS_MED, "$C" = RADIO_CHANNEL_AEGIS_CARGO,

	"#R" = RADIO_CHANNEL_RUBICON_RUN_GEN, "#3" = RADIO_CHANNEL_RUBICON_RUN_CMD, "@E" = RADIO_CHANNEL_RUBICON_RUN_ENGI, "@M" = RADIO_CHANNEL_RUBICON_RUN_MED, "@C" = RADIO_CHANNEL_RUBICON_RUN_CARGO,

	"#P" = RADIO_CHANNEL_PATTONS_GHOST_GEN, "#4" = RADIO_CHANNEL_PATTONS_GHOST_CMD, "&E" = RADIO_CHANNEL_PATTONS_GHOST_ENGI, "&M" = RADIO_CHANNEL_PATTONS_GHOST_MED, "&C" = RADIO_CHANNEL_PATTONS_GHOST_CARGO,
)
