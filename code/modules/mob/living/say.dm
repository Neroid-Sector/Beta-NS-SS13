var/list/department_radio_keys = list(
	...
	"-G" = RADIO_CHANNEL_LIBERTY_STAR_GEN, "-V" = RADIO_CHANNEL_LIBERTY_STAR_CMD, "-E" = RADIO_CHANNEL_LIBERTY_STAR_ENGI, "-M" = RADIO_CHANNEL_LIBERTY_STAR_MED, "-C" = RADIO_CHANNEL_LIBERTY_STAR_CARGO,

	"$G" = RADIO_CHANNEL_AEGIS_GEN, "$V" = RADIO_CHANNEL_AEGIS_CMD, "$E" = RADIO_CHANNEL_ENGI, "$M" = RADIO_CHANNEL_AEGIS_MED, "$C" = RADIO_CHANNEL_AEGIS_CARGO,

	"@G" = RADIO_CHANNEL_RUBICON_RUN_GEN, "@V" = RADIO_CHANNEL_RUBICON_RUN_CMD, "@E" = RADIO_CHANNEL_RUBICON_RUN_ENGI, "@M" = RADIO_CHANNEL_RUBICON_RUN_MED, "@C" = RADIO_CHANNEL_RUBICON_RUN_CARGO,

	"&G" = RADIO_CHANNEL_PATTONS_GHOST_GEN, "&V" = RADIO_CHANNEL_PATTONS_GHOST_CMD, "&E" = RADIO_CHANNEL_PATTONS_GHOST_ENGI, "&M" = RADIO_CHANNEL_PATTONS_GHOST_MED, "&C" = RADIO_CHANNEL_PATTONS_GHOST_CARGO,
)
