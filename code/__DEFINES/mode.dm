...
var/global/list/ROLES_MISC = list(JOB_SYNTH, JOB_WORKING_JOE, JOB_SEA, JOB_COMBAT_REPORTER, JOB_MESS_SERGEANT, JOB_WO_CORPORATE_LIAISON, JOB_WO_SYNTH)
var/global/list/ROLES_POLICE = list(JOB_CHIEF_POLICE, JOB_WARDEN, JOB_POLICE_SL, JOB_POLICE)
...
var/global/list/ROLES_MUDSKIPPER_COMMAND = list(JOB_MS_CO, JOB_MS_XO, JOB_MS_GC, JOB_MS_PC)
var/global/list/ROLES_MUDSKIPPER_SQUAD = list(JOB_MS_SL, JOB_MS_MEDIC, JOB_MS_ENGINEER, JOB_MS_RFM, JOB_MS_SMARTGUNNER)
var/global/list/ROLES_MUDSKIPPER_SUPPORT = list(JOB_MS_HGSL, JOB_MS_VHG, JOB_MS_CMO, JOB_MS_SURGEON, JOB_MS_INTEL, JOB_MS_CREWMAN, JOB_MS_PILOT)
var/global/list/ROLES_MUDSKIPPER_WEYLAND = list(JOB_WYREP_BG, JOB_SCI_BG, JOB_PMC_LEADER_BG, JOB_PMC_BG)
...
var/global/list/ROLES_MUDSKIPPERS = ROLES_MUDSKIPPER_COMMAND + ROLES_MUDSKIPPER_SQUAD + ROLES_POLICE + ROLES_MUDSKIPPER_SUPPORT + ROLES_ENGINEERING + ROLES_REQUISITION + ROLES_MISC + ROLES_MUDSKIPPER_WEYLAND - ROLES_WO

var/global/list/ROLES_DISTRESS_SIGNAL = ROLES_USCM + ROLES_GROUND
var/global/list/ROLES_FACTION_CLASH = ROLES_USCM + JOB_PREDATOR
var/global/list/ROLES_NEROID = ROLES_MUDSKIPPERS
...
#define BLURB_USCM_COMBAT JOB_CO, JOB_XO, JOB_SO, JOB_WO_CO, JOB_WO_XO, JOB_WO_CHIEF_POLICE, JOB_WO_SO, JOB_WO_CREWMAN, JOB_WO_POLICE, JOB_SEA,\
						JOB_SQUAD_LEADER, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_SPECIALIST, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MEDIC, JOB_SQUAD_ENGI, JOB_SQUAD_MARINE, JOB_MS_RFM, JOB_MS_MEDIC, JOB_MS_ENGINEER, JOB_MS_SMARTGUNNER, JOB_MS_SL
#define BLURB_USCM_FLIGHT JOB_PILOT, JOB_DROPSHIP_CREW_CHIEF
#define BLURB_USCM_MP JOB_CHIEF_POLICE, JOB_WARDEN, JOB_POLICE, JOB_MS_VHG, JOB_MS_HGSL
