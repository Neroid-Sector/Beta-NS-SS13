...
var/global/list/ROLES_MUDSKIPPERS = ROLES_MUDSKIPPER_COMMAND + ROLES_MUDSKIPPER_SQUAD + ROLES_MUDSKIPPER_SUPPORT + ROLES_ENGINEERING + ROLES_REQUISITION + ROLES_MISC - ROLES_WO
