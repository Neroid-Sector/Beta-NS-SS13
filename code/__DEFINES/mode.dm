...
GLOBAL_LIST_INIT(ROLES_MS, list(JOB_MS_CO, JOB_MS_XO, JOB_MS_CPT, JOB_MS_LT, JOB_MS_GC, JOB_MS_PC, JOB_MS_RFM, JOB_MS_MEDIC, JOB_MS_ENGINEER, JOB_MS_SMARTGUNNER, JOB_MS_SL, JOB_MS_PILOT, JOB_MS_CREWMAN, JOB_MS_INTEL))
