...
var/global/list/MUDSKIPPER_COMMAND = list(JOB_MS_CO, JOB_MS_XO, JOB_MS_CPT, JOB_MS_LT, JOB_MS_GC, JOB_MS_PC, JOB_MS_ASO)
...
var/global/list/MUDSKIPPER_WYREPS = list(JOB_WYREP_BG, JOB_PMC_LEADER, JOB_PMC_BG, JOB_PMC_SYNTH_BG)
