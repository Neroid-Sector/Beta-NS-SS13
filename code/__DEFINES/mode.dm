...
var/global/list/ROLES_MUDSKIPPERS = MUDSKIPPER_COMMAND + MUDSKIPPER_SQUAD + MUDSKIPPER_SUPPORT + MUDSKIPPER_WYREPS + ROLES_ENGINEERING + ROLES_REQUISITION - ROLES_WO
