...
var/global/list/ROLES_MUDSKIPPERS = MUDSKIPPER_COMMAND + ROLES_POLICE + MUDSKIPPER_SQUAD + MUDSKIPPER_SUPPORT + MUDSKIPPER_WYREPS + ROLES_SPECIAL

var/global/list/ROLES_DISTRESS_SIGNAL = ROLES_USCM + ROLES_GROUND
var/global/list/ROLES_FACTION_CLASH = ROLES_USCM + JOB_PREDATOR
var/global/list/ROLES_NEROID = ROLES_MUDSKIPPERS + ROLES_ENGINEERING + ROLES_REQUISITION + ROLES_POLICE
