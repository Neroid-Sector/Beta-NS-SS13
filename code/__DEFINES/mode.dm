...
var/global/list/MUDSKIPPER_COMMAND = list(JOB_MS_CO, JOB_MS_XO, JOB_MS_CPT, JOB_MS_LT, JOB_MS_GC, JOB_MS_PC)
var/global/list/MUDSKIPPER_SQUAD = list(JOB_MS_RFM, JOB_MS_MEDIC, JOB_MS_ENGINEER, JOB_MS_SMARTGUNNER, JOB_MS_SL)
var/global/list/MUDSKIPPER_SUPPORT = list(JOB_MS_PILOT, JOB_MS_WO, JOB_MS_CREWMAN, JOB_MS_INTEL, JOB_MS_CMO, JOB_MS_SURGEON)
var/global/list/MUDSKIPPER_WYREPS = list(JOB_WYREP_BG, JOB_PMC_LEADER, JOB_PMC_BG)
...
var/global/list/ROLES_USCM = list(ROLES_CIC + ROLES_POLICE + ROLES_AUXIL_SUPPORT + ROLES_MISC + ROLES_ENGINEERING + ROLES_REQUISITION + ROLES_MEDICAL + ROLES_MARINES - ROLES_WO)
var/global/list/ROLES_GROUND = list(ROLES_XENO + ROLES_SPECIAL + ROLES_WHITELISTED)
var/global/list/ROLES_MUDSKIPPERS = list(MUDSKIPPER_COMMAND + MUDSKIPPER_SQUAD + MUDSKIPPER_SUPPORT + MUDSKIPPER_WYREPS + ROLES_ENGINEERING + ROLES_REQUISITION - ROLES_WO)

var/global/list/ROLES_DISTRESS_SIGNAL = list(ROLES_USCM + ROLES_GROUND)
var/global/list/ROLES_FACTION_CLASH = list(ROLES_USCM + JOB_PREDATOR)
var/global/list/ROLES_NEROID = list(ROLES_MUDSKIPPERS, JOB_PREDATOR)
