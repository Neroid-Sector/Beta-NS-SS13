...
var/global/list/ROLES_MUDSKIPPER_COMMAND = list(JOB_MS_CO, JOB_MS_XO, JOB_MS_CPT, JOB_MS_LT, JOB_MS_GC, JOB_MS_PC)
var/global/list/ROLES_MUDSKIPPER_SQUAD = list(JOB_MS_RFM, JOB_MS_MEDIC, JOB_MS_ENGINEER, JOB_MS_SMARTGUNNER, JOB_MS_SL)
var/global/list/ROLES_MUDSKIPPER_SUPPORT = list(JOB_MS_VHG, JOB_MS_HGSL, JOB_MS_CMO, JOB_MS_SURGEON, JOB_MS_INTEL, JOB_MS_CREWMAN, JOB_MS_PILOT)
...
var/global/list/ROLES_MUDSKIPPERS = ROLES_MUDSKIPPER_COMMAND + ROLES_POLICE + ROLES_MUDSKIPPER_SQUAD + ROLES_MUDSKIPPER_SUPPORT + ROLES_ENGINEERING + ROLES_REQUISITION + ROLES_MISC - ROLES_WO
