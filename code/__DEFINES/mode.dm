...
//Merchant Marine
//Liberty
var/global/list/ROLES_LIBERTY = list(JOB_MM_CAPTAIN_LIBERTY, JOB_MM_QUATERMASTER_LIBERTY, JOB_MM_WARRANT_OFFICER_LIBERTY, JOB_MM_CHIEF_MEDICAL_OFFICER_LIBERTY, JOB_MM_CHIEF_ENGINEER_LIBERTY, JOB_MM_DOCTOR_LIBERTY, JOB_MM_CARGO_TECH_LIBERTY, JOB_MM_MAINTENANCE_TECH_LIBERTY, JOB_MM_CHEF_LIBERTY)
//Aegis
var/global/list/ROLES_AEGIS = list(JOB_MM_CAPTAIN_AEGIS, JOB_MM_QUATERMASTER_AEGIS, JOB_MM_WARRANT_OFFICER_AEGIS, JOB_MM_CHIEF_MEDICAL_OFFICER_AEGIS, JOB_MM_CHIEF_ENGINEER_AEGIS, JOB_MM_DOCTOR_AEGIS, JOB_MM_CARGO_TECH_AEGIS, JOB_MM_MAINTENANCE_TECH_AEGIS, JOB_MM_CHEF_AEGIS)
//Rubicon Run
var/global/list/ROLES_RUBICON = list(JOB_MM_CAPTAIN_RUBICON, JOB_MM_QUATERMASTER_RUBICON, JOB_MM_WARRANT_OFFICER_RUBICON, JOB_MM_CHIEF_MEDICAL_OFFICER_RUBICON, JOB_MM_CHIEF_ENGINEER_RUBICON, JOB_MM_DOCTOR_RUBICON, JOB_MM_CARGO_TECH_RUBICON, JOB_MM_MAINTENANCE_TECH_RUBICON, JOB_MM_CHEF_RUBICON)
//Patton Ghost
var/global/list/ROLES_PATTON = list(JOB_MM_CAPTAIN_PATTON, JOB_MM_QUATERMASTER_PATTON, JOB_MM_WARRANT_OFFICER_PATTON, JOB_MM_CHIEF_MEDICAL_OFFICER_PATTON, JOB_MM_CHIEF_ENGINEER_PATTON, JOB_MM_DOCTOR_PATTON, JOB_MM_CARGO_TECH_PATTON, JOB_MM_MAINTENANCE_TECH_PATTON, JOB_MM_CHEF_PATTON)
...
var/global/list/ROLES_MERCHANT_MARINE = ROLES_LIBERTY + ROLES_AEGIS + ROLES_PATTON + ROLES_RUBICON
...
//merchant marine
#define WHITELIST_LIBERTY
#define WHITELIST_AEGIS
#define WHITELIST_RUBICON
#define WHITELIST_PATTON
...
#define FACTION_LIST_COLONIST list(FACTION_COLONIST, FACTION_FREELANCER, FACTION_MARSHAL, FACTION_PMC, FACTION_WY, FACTION_MERCENARY, FACTION_SURVIVOR)
