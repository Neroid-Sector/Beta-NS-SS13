...
var/global/list/ROLES_MUDSKIPPERS = MUDSKIPPER_COMMAND + ROLES_POLICE + MUDSKIPPER_SQUAD + MUDSKIPPER_SUPPORT + MUDSKIPPER_WYREPS + ROLES_SPECIAL + ROLES_ENGINEERING + ROLES_REQUISITION - ROLES_WO
