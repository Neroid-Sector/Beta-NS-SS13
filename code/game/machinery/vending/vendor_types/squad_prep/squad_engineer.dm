...
GLOBAL_LIST_INIT(cm_vending_gear_engi, list(
		...
		list("Concertina Wire x50", 10, /obj/item/stack/concertina_wire/full, null, VENDOR_ITEM_RECOMMENDED),
		list("Fragwire x50", 25, /obj/item/stack/fragwire/full, null, VENDOR_ITEM_RECOMMENDED),
