...
/proc/get_sfx(S)
	if(istext(S))
		switch(S)
			...
			if("gun_pulse_smg")
				S = pick('sound/weapons/gun_m39_1.mp3','sound/weapons/gun_m39_2.mp3','sound/weapons/gun_m39_3.mp3')
			if("gun_pulse")
				S = pick('sound/weapons/gun_m41a_1.mp3','sound/weapons/gun_m41a_2.mp3','sound/weapons/gun_m41a_3.mp3','sound/weapons/gun_m41a_4.mp3','sound/weapons/gun_m41a_5.mp3')
			if("gun_smartgun")
				S = pick('sound/weapons/gun_smartgun1.mp3', 'sound/weapons/gun_smartgun2.mp3', 'sound/weapons/gun_smartgun3.mp3', 'sound/weapons/gun_smartgun4.mp3')
			if("gun_smartgun_rattle")
				S = pick('sound/weapons/gun_smartgun1_rattle.mp3', 'sound/weapons/gun_smartgun2_rattle.mp3', 'sound/weapons/gun_smartgun3_rattle.mp3', 'sound/weapons/gun_smartgun4_rattle.mp3')
			if("gun_jam_rack")
